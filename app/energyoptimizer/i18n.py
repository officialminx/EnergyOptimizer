...
_SERVER: dict[str, str] = {
    ...
    "Automatik": "Automatic",
    "Status": "Status",
    "Laufzeit heute": "Runtime today",
    "Vom Optimizer eingeschaltet": "Switched on by the optimizer",
    "Produktion": "Production",
    "Verbrauch": "Consumption",
    "Netz": "Grid",
    "Verfügbarer Überschuss": "Available surplus",
    "Geschaltete Last": "Managed load",
    "Messwerte veraltet": "Readings stale",
    "Batterie hat Vorrang": "Battery has priority",
    "Batterie": "Battery",
    "Batterie-Ladestand": "Battery level",
    "Gesamt Produktion": "Total production",
    "Gesamt Verbrauch": "Total consumption",
    "Gesamt Netzbezug": "Total grid import",
    "Gesamt Einspeisung": "Total feed-in",
    "Leistung": "Power",
    "Energie": "Energy",
    "Erreichbar": "Reachable",
    "Gerät läuft": "Device running",
    "Extern": "External",
    "Aus": "Off",
    "Wartet auf Überschuss": "Waiting for surplus",
    "Läuft auf Überschuss": "Running on surplus",
    "Nachlauf": "Catching up",
    "Manuell übersteuert": "Manual override",
    "Gesperrt": "Blocked",
    "Automatik aus": "Automatic off",
    "Von Hand eingeschaltet": "Switched on elsewhere",
